          ...
          <div class="auth-sheet-dialog ios-dialog" id="auth-sheet-dialog-ios">
            ...
            ${activeAuthMode === 'phone' ? `
              ...
              <div class="form-group" style="margin-bottom: 16px;">
                ...
                <div style="display: flex; gap: 8px;">
                  ...
                  <input type="tel" id="auth-phone-input-ios" class="m3-input" placeholder="Enter 10-digit mobile number" value="${enteredIdentifier || ''}" style="flex: 1; padding: 12px 14px; background: #f8f4ee; border: 1.5px solid #ede4da; border-radius: 12px; color: #1e293b; font-size: 0.95rem; outline: none; box-sizing: border-box;">
                </div>
              </div>
            ...
            ` : activeAuthMode === 'email' ? `
              ...
              <div class="form-group" style="margin-bottom: 16px;">
                ...
                <div style="display: flex; gap: 8px;">
                  <input type="email" id="auth-email-input-ios" class="m3-input" placeholder="name@sahasraartha.in" value="${enteredIdentifier || ''}" style="width: 100%; padding: 12px 14px; background: #f8f4ee; border: 1.5px solid #ede4da; border-radius: 12px; color: #1e293b; font-size: 0.95rem; outline: none; box-sizing: border-box;">
                </div>
            ...
            ` : `
              ...
              ${activeSheetTab === 'select' ? `
                ...
                <div style="margin-bottom: 10px; display: flex; flex-direction: column; gap: 8px;">
                  <input type="text" id="partner-search-input-ios" placeholder="Search partner name, ID or mobile..." value="${searchQuery}" style="width: 100%; padding: 8px 12px; font-size: 0.82rem; border-radius: 8px; border: 1px solid #ede4da; background: #fbf8f4; outline: none; box-sizing: border-box;">
...
export function attachIOSLoginEvents(onLoginSuccess) {
  ...
  // Submit Email Login
  document.getElementById('btn-sheet-submit-email-ios')?.addEventListener('click', () => {
    const emailInput = document.getElementById('auth-email-input-ios');
