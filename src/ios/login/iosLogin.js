    ...
    <div class="auth-screen-container ios-screen">
      ...
      <div class="auth-footer">
        <div class="auth-footer-prompt">
          Official Partner? <span class="auth-footer-link" id="btn-open-persona-sheet-ios">Partner Account Directory</span>
        </div>
          ...
          <div class="auth-sheet-dialog ios-dialog" id="auth-sheet-dialog-ios">
            ...
            ${activeAuthMode === 'phone' ? `
              ...
              <div class="form-group" style="margin-bottom: 16px;">
                ...
                <div style="display: flex; gap: 8px;">
                  ...
                  <input type="tel" id="auth-phone-input-ios" class="m3-input" placeholder="Enter 10-digit registered mobile" value="${enteredIdentifier || ''}" style="flex: 1; padding: 12px 14px; background: #f8f4ee; border: 1.5px solid #ede4da; border-radius: 12px; color: #1e293b; font-size: 0.95rem; outline: none; box-sizing: border-box;">
                </div>
              </div>
            ...
            ` : activeAuthMode === 'google_fallback' ? `
              ...
              <div style="display: flex; flex-direction: column; gap: 8px; margin-bottom: 14px;">
                <div class="quick-google-account-item-ios" data-email="srikanth@sahasraartha.in" data-name="Srikanth Ayinavolu" style="display: flex; align-items: center; gap: 10px; padding: 10px 12px; background: #ffffff; border: 1.5px solid #e2e8f0; border-radius: 12px; cursor: pointer; transition: all 0.2s ease;">
              ...
              <div style="border-top: 1px dashed #e2e8f0; padding-top: 12px; margin-bottom: 14px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 8px;">
                  <button class="auth-pill-btn-blue" id="btn-instant-custom-google-ios" style="width: 100%;">
                  ...
                  <button class="auth-pill-btn-outline" id="btn-submit-custom-google-ios" style="width: 100%; border: 1.5px solid #e2e8f0; color: #475569; font-size: 0.8rem; padding: 9px 12px;">
            ...
            ` : `
              ...
              <div style="margin-bottom: 10px; display: flex; flex-direction: column; gap: 8px;">
                <input type="text" id="partner-search-input-ios" placeholder="Search partner name, ID, email or mobile..." value="${searchQuery}" style="width: 100%; padding: 9px 12px; font-size: 0.84rem; border-radius: 10px; border: 1.5px solid #ede4da; background: #fbf8f4; outline: none; box-sizing: border-box;">

                <div style="display: flex; gap: 6px; overflow-x: auto; padding-bottom: 2px;">
                  <button class="role-chip-ios ${selectedRoleFilter === 'ALL' ? 'active' : ''}" data-filter="ALL" style="padding: 5px 10px; border-radius: 8px; font-size: 0.7rem; font-weight: 700; border: 1px solid ${selectedRoleFilter === 'ALL' ? '#ea580c' : '#ede4da'}; background: ${selectedRoleFilter === 'ALL' ? '#fff7ed' : '#ffffff'}; color: ${selectedRoleFilter === 'ALL' ? '#ea580c' : '#64748b'}; cursor: pointer; white-space: nowrap;">
                    All (${store.partners.length})
                  </button>
                  <button class="role-chip-ios ${selectedRoleFilter === 'ADMIN' ? 'active' : ''}" data-filter="ADMIN" style="padding: 5px 10px; border-radius: 8px; font-size: 0.7rem; font-weight: 700; border: 1px solid ${selectedRoleFilter === 'ADMIN' ? '#ea580c' : '#ede4da'}; background: ${selectedRoleFilter === 'ADMIN' ? '#fff7ed' : '#ffffff'}; color: ${selectedRoleFilter === 'ADMIN' ? '#ea580c' : '#64748b'}; cursor: pointer; white-space: nowrap;">
                    Managing Partner (${superAdmins.length})
                  </button>
                  <button class="role-chip-ios ${selectedRoleFilter === 'DESIGNATED' ? 'active' : ''}" data-filter="DESIGNATED" style="padding: 5px 10px; border-radius: 8px; font-size: 0.7rem; font-weight: 700; border: 1px solid ${selectedRoleFilter === 'DESIGNATED' ? '#2563eb' : '#ede4da'}; background: ${selectedRoleFilter === 'DESIGNATED' ? '#eff6ff' : '#ffffff'}; color: ${selectedRoleFilter === 'DESIGNATED' ? '#2563eb' : '#64748b'}; cursor: pointer; white-space: nowrap;">
                    Designated (${committeeMembers.length})
                  </button>
                  <button class="role-chip-ios ${selectedRoleFilter === 'LP' ? 'active' : ''}" data-filter="LP" style="padding: 5px 10px; border-radius: 8px; font-size: 0.7rem; font-weight: 700; border: 1px solid ${selectedRoleFilter === 'LP' ? '#10b981' : '#ede4da'}; background: ${selectedRoleFilter === 'LP' ? '#ecfdf5' : '#ffffff'}; color: ${selectedRoleFilter === 'LP' ? '#10b981' : '#64748b'}; cursor: pointer; white-space: nowrap;">
...
export function attachIOSLoginEvents(onLoginSuccess) {
  ...
  document.getElementById('btn-instant-custom-google-ios')?.addEventListener('click', () => {
